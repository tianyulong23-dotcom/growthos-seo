...
// Source SHA-256: 57771dc10623429f7333fa3214a790f9cf47669c51fd74a84f1b85973ebddb5f
...
export type PerformanceBacklinksResponse = {
  items: Array<PerformanceBacklinkCandidate | PerformanceBacklinkPlacement>
...
export interface BacklinksOperations {
  ...
  backlinksCancelQueuedRecommendationRefillV1: {
    method: "POST"
    path: "/api/v1/projects/{websiteProjectKey}/backlinks/recommendation-refill-jobs/{jobId}/cancel"
    pathParameters: {
      websiteProjectKey: string
      jobId: string
    }
  ...
  backlinksCloseDuplicateRecommendationRefillV1: {
    method: "POST"
    path: "/api/v1/projects/{websiteProjectKey}/backlinks/recommendation-refill-jobs/{jobId}/close-duplicate"
    pathParameters: {
      websiteProjectKey: string
      jobId: string
    }
