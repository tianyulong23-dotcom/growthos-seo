...
CALL_INSTRUCTIONS = {
    "plan_article": """Create the search intent, metadata, and a complete outline. The SERP
...
the supplied ArticleContract boundary and answer every required question assigned to this section.
...
all necessary sections, supported citations, and valid internal links. Do not add new facts.""",
...
citation, claim binding, and valid internal link. Do not invent facts, numbers, dates, examples,
people, quotations, prices, or outcomes. Return the complete revised article in the required
schema.""",
...
and follow each matching section_plan and section_requirements checklist. Do not change other
