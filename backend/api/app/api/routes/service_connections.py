...
@router.get("/gsc", response_model=GSCConnectionResponse)
...
@router.put("/gsc", response_model=GSCConnectionResponse)
async def update_gsc_connection(
    project_id: str,
    request: UpdateGSCConnectionRequest,
    service: Annotated[
        ProjectServiceConnectionService,
        Depends(get_service_connection_service),
    ],
...
@router.post("/gsc/test", response_model=TestGSCConnectionResponse)
async def test_gsc_connection(
    project_id: str,
    request: TestGSCConnectionRequest,
    service: Annotated[
        ProjectServiceConnectionService,
        Depends(get_service_connection_service),
    ],
