...
const systemInstruction = [
  ...
  "Include the target website, a concise sender introduction, one concrete cooperation ask, and a low-pressure call to action.",
  "Use only supplied project and website evidence; do not require another website crawl.",
  "When target public content is absent or unavailable, write a generic cooperation inquiry without claims about the target's business, team, articles, or About page.",
  "Personalization is optional. Never claim to have visited or read a page without supporting evidence.",
  "Target markets do not establish company location. Do not turn an audience or market into a headquarters claim.",
  "The subject, greeting, body and signature must be English even if preferences or evidence use another language; proper names, brands, URLs and email addresses may retain their spelling.",
