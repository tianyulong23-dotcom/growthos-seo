...
ALTER TABLE backlink_recommendation_generation_contracts
  DROP CONSTRAINT backlink_rec_generation_values_ck,
  ADD CONSTRAINT backlink_rec_generation_values_v3_2_ck CHECK (
...
ALTER TABLE backlink_recommendation_qualification_facts
  DROP CONSTRAINT backlink_rec_qualification_values_ck,
  ADD CONSTRAINT backlink_rec_qualification_values_v3_2_ck CHECK (
