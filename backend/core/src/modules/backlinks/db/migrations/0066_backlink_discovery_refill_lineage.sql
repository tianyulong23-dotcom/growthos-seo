...
ALTER TABLE backlink_commercial_discovery_batches
  ADD CONSTRAINT backlink_commercial_batch_refill_job_fk
  FOREIGN KEY (
    organization_id, workspace_id, website_project_id, refill_job_id
  )
  REFERENCES backlink_jobs (
    organization_id, workspace_id, website_project_id, id
  );

CREATE INDEX backlink_commercial_batch_refill_job_idx
