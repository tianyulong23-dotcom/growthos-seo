...
const runbook = new URL(
  "../../docs/execution/parallel-blocks/PB-F-METRICS-GOV-backup-restore-runbook-draft.md",
  import.meta.url,
);

describe("BL-AI-175 backup/restore validation", () => {
  it("accepts only temporary restore evidence within RPO/RTO and matching key counts", () => {
    expect(validateBackupRestoreEvidence({
      ...
      expectedMigrationHead: "0031",
      restoredMigrationHead: "0031",
      sourceCounts: {
